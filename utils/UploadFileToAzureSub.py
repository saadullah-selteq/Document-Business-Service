...
def upload_file_to_azure_storagesub(file, businessId, ownerId, virtual_directory, container_name):
    # Replace ACCOUNT_NAME and ACCOUNT_KEY with your Azure Storage account name and key
    blob_service_client = containerClient()

    # Set the name of the blob (file) that will be uploaded
    blob_name = businessId + "/" + ownerId + "/" + virtual_directory + file.name
